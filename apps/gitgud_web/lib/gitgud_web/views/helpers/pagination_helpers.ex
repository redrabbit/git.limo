defmodule GitGud.Web.PaginationHelpers do
  ...
  def paginate(conn, list, limit \\ 20) do
    ...
    %{
      ...
      next: min(page + 1, count),
      first: 1,
      last: count,
      slice: slice(list, (page - 1) * limit, limit)
    }
  end
  ...
  defp pagination_list(page) do
    content_tag(:ul, [class: "pagination-list"],
      do: [
  ...
  defp pagination_previous(%{previous: previous, first: first, last: last}) do
    ...
    |> pagination_ellipsis(if last > 7 && previous > 3, do: 0)
  end
  ...
  defp pagination_next(%{next: next, last: last}) do
    ...
    |> pagination_ellipsis(if last > 7 && last - next > 2, do: i)
  end
  ...
  defp pagination_ellipsis(list, i) do
    List.replace_at(
      list,
      i,
      content_tag(:li, do: content_tag(:span, [class: "pagination-ellipsis"], do: "..."))
    )
  end
